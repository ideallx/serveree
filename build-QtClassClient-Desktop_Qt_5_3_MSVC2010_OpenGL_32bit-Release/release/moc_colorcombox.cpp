/****************************************************************************
** Meta object code from reading C++ file 'colorcombox.h'
**
...
#include "F:/server/trunk/EClass/QtClassClient/UserInterface/colorcombox.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'colorcombox.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ColorCombox_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 50, 16)
    ...
    "OnColorChanged\0OnShowColorBoard"
};
...
const QMetaObject ColorCombox::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_ColorCombox.data,
      qt_meta_data_ColorCombox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ColorCombox.stringdata))
