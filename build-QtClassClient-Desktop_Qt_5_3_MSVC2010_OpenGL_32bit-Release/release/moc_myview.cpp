...
#include "../../QtClassClient/LayerUI/UserInterface/myview.h"
...
QT_MOC_LITERAL(5, 35, 2)
    },
    "MyView\0screenMoved\0\0p\0setPaintMode\0"
    "in"
};
...
void MyView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setPaintMode((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyView::*_t)(QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyView::screenMoved)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyView::screenMoved(QPoint _t1)
{
