/****************************************************************************
** Meta object code from reading C++ file 'IpAddressWidget.h'
**
...
#include "../../QtClassClient/LayerUI/IpAddressWidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'IpAddressWidget.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_IpAddressWidget_t {
    QByteArrayData data[1];
    char stringdata[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_IpAddressWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_IpAddressWidget_t qt_meta_stringdata_IpAddressWidget = {
    {
...
const QMetaObject IpAddressWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_IpAddressWidget.data,
      qt_meta_data_IpAddressWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_IpAddressWidget.stringdata))
