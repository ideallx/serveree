...
"}"));
        ...
        tbReplay = new QToolButton(LoginDialog);
        tbReplay->setObjectName(QStringLiteral("tbReplay"));
        tbReplay->setAutoRaise(true);

        verticalLayout_2->addWidget(tbReplay);
    ...
    {
        tbExit->setText(QApplication::translate("LoginDialog", "X", 0));
        tbReplay->setText(QApplication::translate("LoginDialog", "\350\257\276\347\250\213\345\233\236\346\224\276", 0));
